    ...
    return (
        <div className="bg-green-800 text-white text-opacity-40 font-semibold uppercase text-xs tracking-widest bg-opacity-80 px-12">
            <div className="container mx-auto grid grid-cols-4 py-24">
                <div>
                    <div className="text-white opacity-50 text-4xl font-display">The travel blog</div>
                </div>
                <div>
            ...
            <div className="text-sm lg:text-base text-center font-heading font-light tracking-widest uppercase text-white opacity-75 pb-24">©2021 design by novolio. images by unsplash</div>
        </div>
    );
