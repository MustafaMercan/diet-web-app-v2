...
import { loginRoot } from '../../redux/root/rootSlice'
    ...
    useEffect(() => {
      ...
      useEffect(() => {
        if(information?._id){
          ...
          dispatch(loginRoot(information));
          //navigate('/root')
        }
      }, [information])
    return (
                ...
                <div className="items-center w-full  p-8 mx-auto lg:px-12 lg:w-3/5">
                    ...
                    <div className="w-full">
                        ...
                        <form className="flex flex-col items-center justify-center mt-32 w-full "
                            ...
                            onSubmit={(event) => loginSubmitHandler({ event, setForm: setInformation, data: loginForm, url: '/root/login' })}
                        >
